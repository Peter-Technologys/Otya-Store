...
test('public product copy uses OTYA and Next', () => {
...
test('legacy public AI and player names do not return to primary surfaces', () => {
  assert.doesNotMatch(visible, /Ask Otya/i)
  assert.doesNotMatch(visible, /Ask OTYA/)
  assert.doesNotMatch(product, /Otya Player/)
})
