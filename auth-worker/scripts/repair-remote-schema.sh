...
run_sql "CREATE TABLE IF NOT EXISTS user_public_usernames (username TEXT PRIMARY KEY COLLATE NOCASE, user_id TEXT NOT NULL UNIQUE, created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')), FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE)"
ensure_column user_public_usernames username "TEXT"
ensure_column user_public_usernames user_id "TEXT"
ensure_column user_public_usernames created_at "TEXT"
ensure_column user_public_usernames updated_at "TEXT"
...
run_sql "CREATE UNIQUE INDEX IF NOT EXISTS idx_public_usernames_user ON user_public_usernames(user_id)"
