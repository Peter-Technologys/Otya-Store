...
export const metadata: Metadata = {
  ...
  title: {
    default: 'OTYA System — OTYA Player & Platform',
    template: '%s | OTYA System',
  },
  description:
    'OTYA System is the platform behind OTYA Player and its secure account, backend, update, download and support services.',
  keywords: [
    'OTYA System', 'OTYA Player', 'OTYA Backend', 'OTYA Auth',
    'offline media player Android', 'free music player Android',
    'free video player Android', 'download OTYA Player APK',
    'Flash Share', 'Private Vault Android',
  ],
  authors: [{ name: 'OTYA System', url: SITE_URL }],
  creator: 'OTYA System',
  publisher: 'OTYA System',
  applicationName: 'OTYA System',
  category: 'technology',
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'OTYA System', type: 'image/jpeg' }],
  },
  twitter: {
