...
export const metadata: Metadata = {
  ...
  openGraph:{type:'website',locale:'en_UG',url:SITE_URL,siteName:'OTYA',title:'OTYA — Apps, AI & Connected Services',description:'The official home of OTYA, OTYA Player and OTYA AI.',images:[{url:'/og-image.jpg',width:1200,height:630,alt:'OTYA Player — Your Sound, Your Way',type:'image/jpeg'}]},
  ...
  manifest:'/manifest.json',appleWebApp:{capable:true,title:'OTYA',statusBarStyle:'default'},
}
