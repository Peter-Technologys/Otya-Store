...
export default function SignInPage() {
  ...
  useEffect(() => {
    ...
    else if (telegram === 'not-linked') setNotice('That Telegram account is not linked yet. Create an Otya account or sign in first, then connect Telegram from Space.')
