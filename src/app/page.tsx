          ...
          <div className="grid lg:grid-cols-[1.05fr_.95fr] gap-14 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/otya-player" className="cosmos-button px-5 py-3 rounded-xl font-semibold text-sm">Explore OTYA</Link>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[28px] border p-6 sm:p-8" style={{ borderColor: 'var(--cosmos-divider)', background: 'linear-gradient(145deg, rgba(20,20,28,.96), rgba(8,8,13,.96))' }}>
                <div className="flex items-center gap-4 mb-6">
                  <OtyaMark />
                  <div><p className="text-xs mb-1" style={{ color: 'var(--cosmos-text-secondary)' }}>Featured product</p><h2 className="text-2xl font-black">OTYA Player</h2><p className="text-[11px] mt-1" style={{ color: 'var(--cosmos-primary)' }}>by PeterSmart Link</p></div>
                </div>
