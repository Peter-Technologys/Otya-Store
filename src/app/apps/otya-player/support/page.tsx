    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-sub)' }}>We are here to help. WhatsApp is the fastest way to reach us.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
          <a href="https://wa.me/256775912582?text=Hi! I need help with OTYA Player"
            ...
            <div>
              <div className="font-bold text-sm" style={{ color: 'var(--text)' }}>WhatsApp — Fastest</div>
        ...
        {/* FAQs */}
        <h2 className="font-bold text-xs uppercase tracking-widest mb-4" style={{ color: 'var(--text-muted)' }}>Frequently Asked Questions</h2>
        ...
        <div className="mt-8 flex flex-wrap gap-4 text-sm pt-6 border-t" style={{ borderColor: 'var(--border)' }}>
          <a href="/download/otya-player" className="font-semibold" style={{ color: 'var(--purple)' }}>Download OTYA Player</a>
