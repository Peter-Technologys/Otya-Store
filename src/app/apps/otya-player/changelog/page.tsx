...
const VERSIONS = [
  ...
  ], arm64: `${WORKER_BASE}/releases/v1.2.0/OtyaPlayer-arm64.apk`, arm32: `${WORKER_BASE}/releases/v1.2.0/OtyaPlayer-arm32.apk` },
  ...
  ], arm64: `${WORKER_BASE}/releases/v1.0.0/OtyaPlayer-arm64.apk`, arm32: `${WORKER_BASE}/releases/v1.0.0/OtyaPlayer-arm32.apk` },
]
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a1a] via-[#0d0d2b] to-[#1a0a2e]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
          ...
          {VERSIONS.map((v, vi) => (
            <div key={v.version}>
              ...
              {vi === 0 ? (
                ...
                <div>
                  <p className="text-xs text-slate-500 mb-2">Download v{v.version}:</p>
                  <div className="flex flex-wrap gap-2">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4 text-sm">
          ...
          <Link href="/download/otya-player" className="text-purple-400 hover:text-purple-300">Download latest APK</Link>
        </div>
      </div>
    </div>
  )
