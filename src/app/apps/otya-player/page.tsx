        ...
        <div className="flex flex-col sm:flex-row items-start gap-6 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link href="/apps/otya-player/support" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold border hover:border-purple-400" style={{ borderColor: 'var(--border)', color: 'var(--text)', background: 'var(--card)' }}>Support</Link>
            </div>
          </div>
        </div>
