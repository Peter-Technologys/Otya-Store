...
export default function ConsoleClient() {
  ...
  if(session.loading || !session.authenticated)return <main className="min-h-screen grid place-items-center" style={{background:'var(--cosmos-scaffold)',color:'var(--cosmos-text-primary)'}}><div className="text-center"><OtyaBrandMark size={54} thinking label="Checking Otya Admin access"/><p className="mt-3 text-sm otya-muted">Opening secure admin access…</p></div></main>
